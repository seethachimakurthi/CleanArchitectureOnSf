namespace Yajat.Digitalizer.DynamicCalculator.DataAccess.Service
{
    using System;
    ...
    public abstract class BaseServiceRequest<TEntity> : ServiceHandleError where TEntity : BaseEntity
    {
